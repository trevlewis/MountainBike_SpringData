...
--Specialized
insert into mountain_bike (id, name, manufacturer_id, model_type_id, price, fork_brand, fork_travel, has_rear_shock, rear_shock_brand, rear_shock_travel, tire_size, frame_material)
