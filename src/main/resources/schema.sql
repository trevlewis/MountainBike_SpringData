...
ALTER TABLE PUBLIC.MODEL ADD CONSTRAINT PUBLIC.FK4710B097D6BF938 FOREIGN KEY
(MANUFACTURER_ID) REFERENCES PUBLIC.MANUFACTURER
(ID) NOCHECK;

ALTER TABLE PUBLIC.MODEL ADD CONSTRAINT PUBLIC.FK4710B096FD1D69C FOREIGN KEY
(MODELTYPE_ID) REFERENCES PUBLIC.MODELTYPE
(ID) NOCHECK;
